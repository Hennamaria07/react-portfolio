...
const Home = () => {
    ...
    return (
        <>
            <div className='w-screen overflow-hidden h-screen bg-cyan-950'>
                {/* {init && <Particles
                    id="tsparticles"
    ...
    <p className='text-zinc-300 sm:pt-0 pt-12 md:pt-10 '>__________<span className='sm:inline hidden'>_______</span>_________What is she?</p>
          ...
          <div className="md:w-1/2 pt-10 hidden md:flex md:pl-10">
            <img src="https://space-portfolio-theta.vercel.app/mainIconsdark.svg" alt="" />
          </div>
          <div>
